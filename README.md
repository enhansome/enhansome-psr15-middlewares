...
* [guzlehttp/psr7](https://github.com/guzzle/psr7) ⭐ 7,936 | 🐛 2 | 🌐 PHP | 📅 2026-08-24
* [nyholm/psr7](https://github.com/Nyholm/psr7) ⭐ 1,277 | 🐛 5 | 🌐 PHP | 📅 2025-11-28
* [laminas/laminas-diactoros](https://github.com/laminas/laminas-diactoros) ⭐ 560 | 🐛 33 | 🌐 PHP | 📅 2026-09-05
...
* [laminas/laminas-stratigility](https://github.com/laminas/laminas-stratigility) ⭐ 58 | 🐛 3 | 🌐 PHP | 📅 2026-08-31 - Build and dispatch middleware pipelines.
...
* [sunrise/http-router](https://github.com/sunrise-php/http-router) ⭐ 166 | 🐛 7 | 🌐 PHP | 📅 2026-09-03 - HTTP Router based on PSR-7 and PSR-15
...
* [middlewares/aura-router](https://github.com/middlewares/aura-router) ⭐ 11 | 🐛 0 | 🌐 PHP | 📅 2025-07-10 - Use [Aura.Router](https://github.com/auraphp/Aura.Router/) ⭐ 501 | 🐛 3 | 🌐 PHP | 📅 2025-05-02.
...
* [middlewares/recaptcha](https://github.com/middlewares/recaptcha) ⭐ 5 | 🐛 1 | 🌐 PHP | 📅 2025-03-26 - Use [Google's reCAPTCHA](https://github.com/google/recaptcha) ⭐ 3,575 | 🐛 6 | 🌐 PHP | 📅 2026-04-28 for spam prevention.
* [ellipsephp/cookie-encryption](https://github.com/ellipsephp/cookie-encryption) ⭐ 4 | 🐛 1 | 🌐 PHP | 📅 2023-05-01 - Encrypt cookies with a key

### Session

* [Storageless JWT Session](https://github.com/psr7-sessions/storageless) ⭐ 650 | 🐛 3 | 🌐 PHP | 📅 2026-09-05 - Manage sessions without I/O usage (JWT).
...
* [middlewares/whoops](https://github.com/middlewares/whoops) ⭐ 33 | 🐛 0 | 🌐 PHP | 📅 2025-04-27 - Use [Whoops](https://github.com/filp/whoops) ⭐ 13,234 | 🐛 8 | 🌐 PHP | 📅 2026-09-05 as error handler.
...
* [PSR-15 Middlewares by Middlewares Organization](https://github.com/middlewares/psr15-middlewares) ⭐ 411 | 🐛 0 | 📅 2025-04-05
