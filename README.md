...
* [middlewares/recaptcha](https://github.com/middlewares/recaptcha) ⭐ 5 | 🐛 1 | 🌐 PHP | 📅 2025-03-26 - Use [Google's reCAPTCHA](https://github.com/google/recaptcha) ⭐ 3,577 | 🐛 0 | 🌐 PHP | 📅 2026-09-23 for spam prevention.
* [ellipsephp/cookie-encryption](https://github.com/ellipsephp/cookie-encryption) ⭐ 4 | 🐛 1 | 🌐 PHP | 📅 2023-05-01 - Encrypt cookies with a key

### Session

* [Storageless JWT Session](https://github.com/psr7-sessions/storageless) ⭐ 650 | 🐛 3 | 🌐 PHP | 📅 2026-09-25 - Manage sessions without I/O usage (JWT).
